...
const NewK12ComplexAssessment = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.log(
        "🔄 Processing K-12 Complex Analysis with three-step workflow..."
      );
      ...
      console.log(
        `Using K12 endpoint: ${endpoint} (environment: ${environment}, isDemo: ${isDemoEnvironment})`
      );
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Advanced three-step workflow: Technical identification → Canonical
            matching → Item master population
          </p>
        </div>
        <Button
